...
$two_exclude_owl = $TwoSettings->get_settings("two_exclude_owl");
$two_exclude_slick = $TwoSettings->get_settings("two_exclude_slick");
$two_exclude_slider_by_10web = $TwoSettings->get_settings("two_exclude_slider_by_10web");
$two_exclude_elementor_scripts = $TwoSettings->get_settings("two_exclude_elementor_scripts");
$two_exclude_photo_gallery_by_10web = $TwoSettings->get_settings("two_exclude_photo_gallery_by_10web");
$two_exclude_amp_plugin_cdn = $TwoSettings->get_settings("two_exclude_amp_plugin_cdn");
$two_exclude_google_ads = $TwoSettings->get_settings("two_exclude_google_ads");
...
$two_exclude_owl_check = ($two_exclude_owl == "on") ? 'checked' : '';
$two_exclude_slick_check = ($two_exclude_slick == "on") ? 'checked' : '';
$two_exclude_slider_by_10web_check = ($two_exclude_slider_by_10web == "on") ? 'checked' : '';
$two_exclude_elementor_scripts_check = ($two_exclude_elementor_scripts == "on") ? 'checked' : '';
$two_exclude_photo_gallery_by_10web_check = ($two_exclude_photo_gallery_by_10web == "on") ? 'checked' : '';
$two_exclude_amp_plugin_cdn_check = ($two_exclude_amp_plugin_cdn == "on") ? 'checked' : '';
$two_exclude_google_ads_check = ($two_exclude_google_ads == "on") ? 'checked' : '';
...
<div class="two_settings_container" dir="ltr" xmlns="http://www.w3.org/1999/html">
    <div class="two_settings wd-box-section">
        <div class="wd-box-title">
            ...
            <strong><?php $mode = get_option( "two_default_mode", OptimizerUtils::MODES["extreme"] ); echo is_array($mode) && !empty($mode['mode']) ? esc_html(ucfirst($mode['mode'])) : 'No'; // phpcs:ignore ?></strong> mode
        </div>
        ...
        <form class="two_settings_form" action="" method="post">
            ...
            <div class="two_settings_tab two_tab_js">
                ...
                <div class="two_settings_option two_exclude_owl" <?php if ($two_delay_all_js_execution != "on")
                    echo 'style="display:none"' ?>>
                    <input <?php echo esc_html( $two_exclude_owl_check ); ?> type="checkbox" name="two_exclude_owl"
                                                                     id="two_exclude_owl">
                    <label for="two_exclude_owl"
                           class="wd-label"><?php _e('Exclude owl slider', 'tenweb-speed-optimizer'); ?></label>
                    <p class="description"><?php _e('Exclude owl slider js', 'tenweb-speed-optimizer') ?></p>
                </div>
                <div class="two_settings_option two_exclude_slick" <?php if ($two_delay_all_js_execution != "on")
                    echo 'style="display:none"' ?>>
                    <input <?php echo esc_html( $two_exclude_slick_check ); ?> type="checkbox" name="two_exclude_slick"
                                                                     id="two_exclude_slick">
                    <label for="two_exclude_slick"
                           class="wd-label"><?php _e('Exclude slick slider', 'tenweb-speed-optimizer'); ?></label>
                    <p class="description"><?php _e('Exclude slick slider js', 'tenweb-speed-optimizer') ?></p>
                </div>
                ...
                <div class="two_settings_option two_exclude_elementor_scripts" <?php if ($two_delay_all_js_execution != "on")
                  echo 'style="display:none"' ?>>
                    <input <?php echo esc_html( $two_exclude_elementor_scripts_check ); ?> type="checkbox" name="two_exclude_elementor_scripts"
                                                                                         id="two_exclude_elementor_scripts">
                    <label for="two_exclude_elementor_scripts"
                           class="wd-label"><?php _e('Exclude Elementor scripts', 'tenweb-speed-optimizer'); ?></label>
                    <p class="description"><?php _e('Exclude Elementor js', 'tenweb-speed-optimizer') ?></p>
                </div>

                <div class="two_settings_option two_exclude_photo_gallery_by_10web" <?php if ($two_delay_all_js_execution != "on")
                    echo 'style="display:none"' ?>>
                    <input <?php echo esc_html( $two_exclude_photo_gallery_by_10web_check ); ?> type="checkbox" name="two_exclude_photo_gallery_by_10web"
                                                                                         id="two_exclude_photo_gallery_by_10web">
                    <label for="two_exclude_photo_gallery_by_10web"
                           class="wd-label"><?php _e('Exclude Photo Gallery by 10Web', 'tenweb-speed-optimizer'); ?></label>
                    <p class="description"><?php _e('Exclude Photo Gallery by 10Web js', 'tenweb-speed-optimizer') ?></p>
                </div>

                <div class="two_settings_option two_exclude_amp_plugin_cdn" <?php if ($two_delay_all_js_execution != "on")
                    echo 'style="display:none"' ?>>
                    <input <?php echo esc_html( $two_exclude_amp_plugin_cdn_check ); ?> type="checkbox" name="two_exclude_amp_plugin_cdn"
                                                                                                id="two_exclude_amp_plugin_cdn">
                    <label for="two_exclude_amp_plugin_cdn"
                           class="wd-label"><?php _e('Exclude AMP Plugin', 'tenweb-speed-optimizer'); ?></label>
                    <p class="description"><?php _e('Exclude AMP Plugin js', 'tenweb-speed-optimizer') ?></p>
                </div>

                <div class="two_settings_option two_exclude_google_ads" <?php if ($two_delay_all_js_execution != "on")
                    echo 'style="display:none"' ?>>
                    <input <?php echo esc_html( $two_exclude_google_ads_check ); ?> type="checkbox" name="two_exclude_google_ads"
                                                                                         id="two_exclude_google_ads">
                    <label for="two_exclude_google_ads"
                           class="wd-label"><?php _e('Exclude Google Ads', 'tenweb-speed-optimizer'); ?></label>
                    <p class="description"><?php _e('Exclude Google Ads js', 'tenweb-speed-optimizer') ?></p>
                </div>
